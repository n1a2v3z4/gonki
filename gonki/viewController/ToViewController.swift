...
//        for i in 1...20 {
        ...
        timer = Timer.scheduledTimer(withTimeInterval: 3, repeats: true, block: { _ in
                ...
                self.randTime = Int.random(in: 10...30)
                self.randDelay = Int.random(in: 4...6)
                ...
                case 1: 
                    ...
                    UIView.animate(withDuration: TimeInterval(self.randDelay), delay: 0, options: .curveEaseIn ) {
                        ...
                        verticalConstraint.constant = self.view.frame.height*0.5
...
//                    }
                ...
                case 2:      var wood: UIImageView
                    ...
                    self.view.addSubview(wood)
                    UIView.animate(withDuration: TimeInterval(self.randDelay), delay: 0, options: .curveEaseIn ) {
                        wood.center = CGPoint(x: self.view.frame.maxX*0.5, y: self.view.frame.maxY + 100)
                        self.view.bringSubviewToFront(self.lowerView)
                ...
                case 3:
                    ...
                    self.view.addSubview(wood)
                    UIView.animate(withDuration: TimeInterval(self.randDelay), delay: 0, options: .curveEaseIn ) {
                        wood.center = CGPoint(x: self.view.frame.maxX*0.85, y: self.view.frame.maxY + 100)
                        self.view.bringSubviewToFront(self.lowerView)
